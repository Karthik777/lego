...
from fasthtml.common import RedirectResponse, Path, Database

__all__ = ['cfg', 'database', 'AppErr', 'boss_redirect', 'home']

d = dict(domain="http://localhost:5001", db="db/app.db", app_nm="Lego", app_id="lego", app_sh="LG",
