...
def base(content=None, usr=None, title=s.app_nm, sh=s.app_sh, style=NavBarT.glass, cls='min-h-screen figma-board', **kwargs):
    return Title(title), Div(navbar(usr=usr, title=sh, style=style), main(content, **kwargs), cls=f'{cls}')
